...
export default function CottageBookingPage() {
  ...
  return <CottageBookingForm cottageId={cottageId} />;
}
...
//   if (loadingCottages) {
//     return <div>Загрузка коттеджей...</div>;
//   }
...
//   // Класс для подсветки занятых дат
//   const dayClassName = (date: Date) => {
//     return isDateBusy(date) ? styles['busy-date'] : '';
//   };
...
//   // Валидация (оставляем, чтобы не слать запрос, но ошибки показываем через toast)
...
//       toast.error('Ошибка сервера: получен неожиданный ответ');
//       setIsSubmitting(false);
//     }
//   } catch (err) {
